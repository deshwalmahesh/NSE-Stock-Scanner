...
def analyse_option_chain(symbol, compare_with:tuple = ('openInterest','changeinOpenInterest','totalTradedVolume','change'), expiry_dates:tuple = None, top_n:int = 5, expiry_type:str = 'monthly', plot:bool = True, fig_size = (25,10)):
    '''
