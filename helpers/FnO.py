...
def analyse_open_interest(symbol, compare_with:tuple = ('openInterest','changeinOpenInterest','totalTradedVolume','change'), expiry_dates:tuple = None, top_n:int = 5, expiry_type:str = 'monthly'):
    '''
